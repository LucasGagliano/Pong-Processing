...
class Game
{
  ...
  public void Niveis(int levelIndex)
  {
  ...
  public void Menu(int parteMenu)
  {
    menuAberto = false;
    ...
    switch(parteMenu)
    {
        ...
        else
        {
          if(duracaoAnimacao != 0)
          {
            ...
            if(duracaoAnimacao < 255)
            {
              ...
              text("POSSUIR QUAISQUER FINS LUCRATIVOS", width / 2 - textWidth("POSSUIR QUAISQUER FINS LUCRATIVOS") / 2, height / 2 + (textAscent() / 2) * 2.95f);
              duracaoAnimacao += 0.85f;
            }
      ...
      case 1:
        if(!estaFazendoAnimacao)
        {
          ...
          estaNoBotao[1] = UI.CriarBotoes(pa, 't', width / 2 - textWidth("ABCDEFGH") / 2, height / 2 + ((height / 2) / 8) * 2.75f, "CONFIGURAÇÔES", 55);
          estaNoBotao[2] = UI.CriarBotoes(pa, 't', width / 2 - textWidth("ABCDEFGH") / 2, height / 2 + ((height / 2) / 8) * 4.5f, "CRÉDITOS", 55);
          estaNoBotao[3] = UI.CriarBotoes(pa, 't', width / 2 - textWidth("ABCDEFGH") / 2, height / 2 + ((height / 2) / 8) * 6.25f, "SAIR", 55);
          
          fill(255);
          square(width / 2 - textWidth("ABCDEFGH") / 2 - 50 / 2, height / 2 + ((height / 2) / 8) * 1 - textAscent() / 2 + 7.5f, 15);
          square(width / 2 - textWidth("ABCDEFGH") / 2 - 50 / 2, height / 2 + ((height / 2) / 8) * 2.75f - textAscent() / 2 + 7.5f, 15);
          square(width / 2 - textWidth("ABCDEFGH") / 2 - 50 / 2, height / 2 + ((height / 2) / 8) * 4.5f - textAscent() / 2 + 7.5f, 15);
          square(width / 2 - textWidth("ABCDEFGH") / 2 - 50 / 2, height / 2 + ((height / 2) / 8) * 6.25f - textAscent() / 2 + 7.5f, 15);
        }
        else
        {
      ...
      case 3:
        ...
        text("PROGRAMAÇÃO", width / 2 - textWidth("PROGRAMAÇÃO") / 2, height / 2 + ((height / 2) / 8) * 3.75f);
        
        textSize(30);
        text("BERNARDO MIGUEL GERÔNIMO DA CRUZ SILVA", width / 2 - textWidth("BERNARDO MIGUEL GERÔNIMO DA CRUZ SILVA") / 2, height / 2 + ((height / 2) / 8) * 0.75f);
        text("LUCAS MARTIN MACEDO GAGLIANO", width / 2 - textWidth("LUCAS MARTIN MACEDO GAGLIANO") / 2, height / 2 + ((height / 2) / 8) * 4.5f);
        
        textSize(20);
        text("RA: 21424187", width / 2 - textWidth("RA: 21424187") / 2, height / 2 + ((height / 2) / 8) * 1.25f);
      ...
      case 4:
        ...
        estaNoBotao[1] = UI.CriarBotoes(pa, 't', width / 2 - textWidth("ABCDEFGH") / 2, height / 2 + ((height / 2) / 8) * 2.75f, "2 JOGADORES", 55);
        estaNoBotao[2] = UI.CriarBotoes(pa, 't', width / 13, height - (height / 16), "VOLTAR", 55);
      ...
      case 5:
        ...
        estaNoBotao[1] = UI.CriarBotoes(pa, 't', width / 2 - textWidth("ABCDEFGH") / 2, height / 2 + ((height / 2) / 8) * 2.75f, "MÉDIO", 55);
        estaNoBotao[2] = UI.CriarBotoes(pa, 't', width / 2 - textWidth("ABCDEFGH") / 2, height / 2 + ((height / 2) / 8) * 4.5f, "DIFÍCIL", 55);
  ...
  public void NivelUm()
  {
    ...
    text(pontosj1, width / 4 - textWidth(PApplet.parseChar(pontosj1)) / 2, height / 8);
    text(pontosj2, width / 2 + width / 4 - textWidth(PApplet.parseChar(pontosj2)) / 2, height / 8);
    ...
    if(menuAberto)
    {
      ...
      estaNoBotao[1] = UI.CriarBotoes(pa, 't', width / 2 - textWidth("ABCDEFGH") / 2, height / 2 + ((height / 2) / 8) * 2.75f, "MENU", 55); 
  ...
  public void GameOver()
  {
    ...
    estaNoBotao[0] = UI.CriarBotoes(pa, 't', width / 2 - textWidth("ABCDEFGH") / 2, height / 2 + ((height / 2) / 8) * 2.75f, "MENU", 55);
    
    fill(255);
    square(width / 2 - textWidth("ABCDEFGH") / 2 - 50 / 2, height / 2 + ((height / 2) / 8) * 2.75f - textAscent() / 2, 15);
  }
  
  public void AcoesBotoes(int indexBotao)
  {
    switch(levelIndex)
    {
      case 1:
      ...
      case 5:
        switch(indexBotao)
        {
          case 0:
            ...
            j[1].multiplicador = 1.035f;
            levelIndex = 6;
            break;
          case 1:
            b.direcaoHorizontal = direcoes[parseInt(random(-1, 2))];
            j[1].multiplicador = 1.065f;
            levelIndex = 6;
            break;
          case 2:
            b.direcaoHorizontal = direcoes[parseInt(random(-1, 2))];
            j[1].multiplicador = 1.095f;
            levelIndex = 6;
            break;
          case 3:
            levelIndex = 4;
...
class Jogador
{
  ...
  public void Spawn(float posicaoInicialX, float posicaoInicialY)
  {
    posicaoAtualY = posicaoInicialY;
    posicaoAtualX = posicaoInicialX;
  }
  
  public void Mover(String tipoJogador, boolean teclaPositiva, boolean teclaNegativa)
  {
    float forcaMovimentoVertical = 6.5f;
      ...
      switch(tipoJogador)
      {
        ...
        case "AI":
          if(b.direcaoHorizontal == 1 || b.direcaoHorizontal == -1)
          {
            ...
            {
              g.tempo = 0;
              forcaMovimentoVertical = random(6, 6.5f);
            }
  ...
  public void Mover(String jogador)
  {
...
class Bola
{
  ...
  public void Mover()
  {
    if(!g.menuAberto)
    {
      float forcaMovimentoHorizontal = 5.205f;
      float forcaMovimentoVertical = 4.75f;
      ...
      { 
        ...
        if(Collider.IsRectColliding(posicaoAtualY, 0, 0, 0, (height / 5) * 2, 0))
        {
          ...
          else
          {
            ...
            {
              direcaoVertical = 1;
              angulacao = random(1.25f, 1.85f);
            }
            //Se colidir com a segunda parte do jogador
            else if((Collider.IsRectColliding(posicaoAtualY, 0, j[x].posicaoAtualY + j[x].alturaBloco, 0, j[x].posicaoAtualY + j[x].alturaBloco * 2, 0)))
            {
              direcaoVertical = 1;
              angulacao = random(0.45f, 0.85f);
            }
            //Se colidir com a terceira parte do jogador
            else if((Collider.IsRectColliding(posicaoAtualY, 0, j[x].posicaoAtualY + j[x].alturaBloco * 2, 0, j[x].posicaoAtualY + j[x].alturaBloco * 3, 0)))
            {
        ...
        else
        {
            ...
            {
              direcaoVertical = -1;
              angulacao = random(1.75f, 2.25f);
            }
            //Se colidir com a segunda parte do jogador
            else if((Collider.IsRectColliding(posicaoAtualY, 0, j[x].posicaoAtualY + j[x].alturaBloco, 0, j[x].posicaoAtualY + j[x].alturaBloco * 2, 0)))
            {
              direcaoVertical = -1;
              angulacao = random(1, 1.5f);
            }
            //Se colidir com a terceira parte do jogador
...
{  
  public void TocarSom(SoundFile som)
  {
    som.stop();
    som.play();
  }
}
  public void settings() {  size(1280, 732); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Pong2" };
    if (passedArgs != null) {
